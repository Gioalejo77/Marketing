...
# ------------------------------
# (Se mantiene todo igual que tu script original, incluyendo parse_effective_to_date, coalesce_pandas, money, pct, prepare_df, filtros, FAQ, NLP, dashboard, etc.)

# Ejemplo de llamada a prepare_df
